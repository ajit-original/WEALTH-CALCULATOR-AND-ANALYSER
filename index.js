...
const dblmoneybtn = document.getElementById('doubleMoney');
const showmillionairesbtn = document.getElementById('showMillionaires');
const sortbtn = document.getElementById('sortByRichest');
const totalbtn = document.getElementById('calculateWealth');
